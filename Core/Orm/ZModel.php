...
class ZModel extends ZOrmAbstract implements IteratorAggregate, ArrayAccess, Countable {
    ...
    public function __construct(array $row, ZTable $result) {
        $this->row = $row;
        $this->result = $result;
    }
    ...
    */
    public function update($data = null) {
        ...
        $result = new NotORM_Result($this->result->table, $this->result->connection);
    ...
    */
    ...
    protected function access($key, $delete = false) {
        ...
        if ($this->result->connection->cache && !isset($this->modified[$key]) && $this->result->access($key, $delete)) {
